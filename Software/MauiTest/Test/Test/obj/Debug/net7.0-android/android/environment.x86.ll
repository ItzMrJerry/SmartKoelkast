...
@__app_environment_variables_v_3.7 = internal constant [37 x i8] c"cfaddf68-2bb6-4686-9c06-cd756bc67c15\00", align 1
...
@__ApplicationConfig_android_package_name.0 = internal constant [21 x i8] c"com.companyname.test\00", align 1
...
@application_config = local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 322, ; number_of_assemblies_in_apk
...
@__DSOCacheEntry_name.1 = internal constant [29 x i8] c"libSystem.IO.Ports.Native.so\00", align 1
...
@dso_cache = local_unnamed_addr global [36 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 39299967, ; hash 0x257ab7f, from name: libSystem.IO.Ports.Native.so
		i8 0, ; ignore
	...
	; 1
	%struct.DSOCacheEntry {
		i64 42613030, ; hash 0x28a3926, from name: libSystem.IO.Ports.Native
		i8 0, ; ignore
		i8* getelementptr inbounds ([29 x i8], [29 x i8]* @__DSOCacheEntry_name.1, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 7
	%struct.DSOCacheEntry {
		i64 657191125, ; hash 0x272bf0d5, from name: System.IO.Ports.Native
		i8 0, ; ignore
		i8* getelementptr inbounds ([29 x i8], [29 x i8]* @__DSOCacheEntry_name.1, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 8
	%struct.DSOCacheEntry {
		i64 676559055, ; hash 0x285378cf, from name: System.IO.Ports.Native.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([29 x i8], [29 x i8]* @__DSOCacheEntry_name.1, i32 0, i32 0), ; name
		i8* null; handle
	}, 
...
@bundled_assemblies = local_unnamed_addr global [322 x %struct.XamarinAndroidBundledAssembly] [
	; 0
