...
@__app_environment_variables_v_3.7 = internal constant [37 x i8] c"cfaddf68-2bb6-4686-9c06-cd756bc67c15\00", align 16
...
@__ApplicationConfig_android_package_name.0 = internal constant [21 x i8] c"com.companyname.test\00", align 16
...
@__DSOCacheEntry_name.3 = internal constant [29 x i8] c"libSystem.IO.Ports.Native.so\00", align 16
...
@dso_cache = local_unnamed_addr global [36 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; ignore
		i8* getelementptr inbounds ([29 x i8], [29 x i8]* @__DSOCacheEntry_name.3, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 3
	%struct.DSOCacheEntry {
